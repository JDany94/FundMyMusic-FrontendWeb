...
const Searcher = () => {
  ...
  const { searcher, handleSearcher, concerts } = useConcerts();

  const navigate = useNavigate()

  const filter = search === '' ? [] : concerts.filter(concert => concert.title.toLowerCase().includes(search.toLowerCase()))
      ...
      >
        ...
        >
          <Combobox
            ...
            onChange={(concert) => (handleSearcher(), navigate(`/dashboard/${concert._id}`))}
          >
